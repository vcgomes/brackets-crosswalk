...
static const struct XW_CoreInterface_1* g_core_interface;
static const struct XW_MessagingInterface_1* g_messaging_interface;

typedef std::map<uint32_t, struct BracketsExtensionContext*> ContextMap;
static ContextMap g_context_map;

static struct BracketsExtension* g_brackets;
}
